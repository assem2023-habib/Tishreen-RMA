...
start "Laravel Server (Port 8000)" cmd /k "php artisan serve --host=10.105.155.236 --port=8000"

echo [2/5] Starting Laravel Reverb (WebSockets)...
start "Laravel Reverb" cmd /k "php artisan reverb:start --host=10.105.155.236 --port=6001 --debug"
